...
public class StreamAPI {
    ...
    // Sử dụng Map trong streamAPI
    public static void loadMap() {
        ArrayList<String> languages = (ArrayList<String>) Arrays.asList("Java", "Python", "C++", "C#");
        languages.stream()
                .map(String::valueOf)
                .forEach(System.out::println);
    }

    // su dung collect trong streamAPI
    public static void loadCollect() {
        Stream<String> data = Stream.of("Java", "Python", "C++", "C#");
        List<String> languages = data.collect(Collectors.toList());
